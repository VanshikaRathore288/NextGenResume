...
from utils.cover_letter_gen import CoverLetterGenerator
from utils.interview_gen import MockInterviewGenerator
import traceback
...
st.set_page_config(
    page_title="NextGen Resume Analyzer",
    page_icon="🚀",
    layout="wide"
)
...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/vanshika-rathore/NextGen-Resume-Analyzer' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/patel-hetkumar-sandipbhai-8b110525a/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Vanshika Rathore (vanshika-rathore)</b>
                </a>
            </p>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Awesome Hacking](https://github.com/vanshika-rathore/Awesome-Hacking)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [30-Days-Of-Rust](https://github.com/vanshika-rathore/30-Days-Of-Rust)", icon="ℹ️")
     ...
     "124852522.jpeg")
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About NextGen Resume Analyzer</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/vanshika-rathore'}"
                     alt="Vanshika Rathore"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/vanshika-rathore';">
                ...
                <p class="bio-text">
                    ...
                    I created NextGen Resume Analyzer to revolutionize how job seekers approach their career journey.
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "NextGen Resume Analyzer represents my vision of democratizing career advancement through technology.
        ...
        st.toast("Check out these repositories: [Iriswise](https://github.com/vanshika-rathore/Iriswise)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Awesome Java](https://github.com/vanshika-rathore/Awesome-Java)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/vanshika-rathore/AI-Nexus)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [GeeksforGeeks-POTD](https://github.com/vanshika-rathore/GeeksforGeeks-POTD)", icon="ℹ️")
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [TryHackMe Free Rooms](https://github.com/vanshika-rathore/tryhackme-free-rooms)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/vanshika-rathore/tryhackme-free-rooms" target="_blank" style="color: #4CAF50;">TryHackMe Free Rooms</a></li>
        <li><a href="https://github.com/vanshika-rathore/Awesome-Hacking" target="_blank" style="color: #4CAF50;">Awesome Hacking</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Programming Languages:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/vanshika-rathore/Awesome-Java" target="_blank" style="color: #4CAF50;">Awesome Java</a></li>
        <li><a href="https://github.com/vanshika-rathore/30-Days-Of-Rust" target="_blank" style="color: #4CAF50;">30 Days Of Rust</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Data Structures & Algorithms:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/vanshika-rathore/GeeksforGeeks-POTD" target="_blank" style="color: #4CAF50;">GeeksforGeeks POTD</a></li>
        <li><a href="https://github.com/vanshika-rathore/Leetcode-POTD" target="_blank" style="color: #4CAF50;">Leetcode POTD</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>AI/ML Projects:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/vanshika-rathore/AI-Nexus" target="_blank" style="color: #4CAF50;">AI Nexus</a></li>
    </ul>
...
"""
    ...
    def render_cover_letter(self):
        ...
        st.markdown("Generate a tailored professional cover letter based on your resume and a job description.")
        ...
        if st.button("Generate Cover Letter", type="primary"):
            if resume_text and job_desc:
                with st.spinner("Generating Cover Letter..."):
                    result = self.cover_letter_gen.generate(resume_text, job_desc)
                    st.success("Cover Letter Generated Successfully!")
                    st.markdown(result)
                    st.download_button("Download Cover Letter (Markdown)", data=result, file_name="Cover_Letter.md")
            else:
                st.warning("Please provide both resume text and job description.")

    def render_mock_interview(self):
        st.title("🎤 Mock Interview Q&A")
        st.markdown("Get tailored interview questions based on your resume and target role.")
        
        resume_text = st.text_area("Paste your Resume text here:", height=200)
        role = st.text_input("Target Role (e.g., Software Engineer, Data Scientist):", "General")
        
        if st.button("Generate Interview Questions", type="primary"):
            if resume_text:
                with st.spinner("Generating Interview Questions..."):
                    result = self.mock_interview_gen.generate_questions(resume_text, role)
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            for page_name in self.pages.keys():
                if st.button(page_name, width='stretch'):
                    cleaned_name = page_name.lower().replace(" ", "_").replace("🏠", "").replace("🔍", "").replace("📝", "").replace("📊", "").replace("🎯", "").replace("💬", "").replace("ℹ️", "").replace("✉️", "").replace("🎤", "").strip()
                    st.session_state.page = cleaned_name
                    st.rerun()
        ...
        page_mapping = {name.lower().replace(" ", "_").replace("🏠", "").replace("🔍", "").replace("📝", "").replace("📊", "").replace("🎯", "").replace("💬", "").replace("ℹ️", "").replace("✉️", "").replace("🎤", "").strip(): name 
